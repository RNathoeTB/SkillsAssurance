describe('Settings > Personnel settings', () => {
    ...
    it('Validation on Add/Edit Personnel Status', () => {
    ...
    // The pop-up is closed.
     ...
     cy.get('.svx-button > .telerik-blazor').click()
     cy.get(':nth-child(1) > .svx-formfield-content > .input-group > .k-textbox').type('Status 2').wait(2000)
     ...
     cy.wait(1000)
     cy.get('[data-col-index="1"] > .k-filtercell > .k-filtercell-wrapper > .k-textbox').type('Status 2')
     cy.get('.k-grid-content').contains('Status 2')
